...
class NormalProductCell: UICollectionViewCell {
    ...
    var onAddToCartTapped: ((Product) -> Void)?
...
class NormalProductCell: UICollectionViewCell {
    ...
    private func setupViews() {
        ...
        mainContentView.addSubview(infoStackView)
        mainContentView.addSubview(addToCartButton)
        ...
        let infoTrailingConstraint = infoStackView.trailingAnchor.constraint(equalTo: mainContentView.trailingAnchor, constant: -8)
            infoTrailingConstraint.priority = .defaultLow
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.topAnchor.constraint(equalTo: mainContentView.topAnchor),
            imageView.leadingAnchor.constraint(equalTo: mainContentView.leadingAnchor),
            imageView.trailingAnchor.constraint(equalTo: mainContentView.trailingAnchor),
            imageView.heightAnchor.constraint(equalTo: imageView.widthAnchor),
            
            
            infoStackView.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 8),
            infoStackView.leadingAnchor.constraint(equalTo: mainContentView.leadingAnchor, constant: 8),
            infoStackView.trailingAnchor.constraint(lessThanOrEqualTo: addToCartButton.leadingAnchor, constant: -8),
            infoTrailingConstraint,
            infoStackView.bottomAnchor.constraint(lessThanOrEqualTo: mainContentView.bottomAnchor, constant: -8),
            titleLabel.heightAnchor.constraint(greaterThanOrEqualToConstant: titleLabel.font.lineHeight * 2),
            ...
            addToCartButton.trailingAnchor.constraint(equalTo: mainContentView.trailingAnchor, constant: -8),
            addToCartButton.bottomAnchor.constraint(equalTo: mainContentView.bottomAnchor, constant: -8),
            addToCartButton.widthAnchor.constraint(equalToConstant: 30),
            addToCartButton.heightAnchor.constraint(equalToConstant: 30),
            addToCartButton.topAnchor.constraint(greaterThanOrEqualTo: infoStackView.bottomAnchor, constant: 8),
    ...
    func configure(with product: Product, isFavorited: Bool) {
        ...
        let heartImage = isFavorited ? UIImage(systemName: "heart.fill") : UIImage(systemName: "heart")
        let heartColor: UIColor = isFavorited ? .n11Purple : .systemGray
        favoriteButton.setImage(heartImage, for: .normal)
        favoriteButton.tintColor = heartColor
